// src/main.js
/**
 * Main entry point for AdvancedCryptoFramework application
 */
...
class AdvancedCryptoFramework {
    /**
     * Create a new AdvancedCryptoFramework instance
...
module.exports = AdvancedCryptoFramework;
...
if (require.main === module) {
    ...
    const app = new AdvancedCryptoFramework({
        input: args.input,
        output: args.output,
